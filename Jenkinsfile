   ...
   stage('Deploy') {
      ...
      sshagent(credentials: ['a54789ce-6d79-4114-a78c-1dff917fec83']) {
        ...
        sh '''
          ...
          ssh -i "/path/to/riasec_app.pem" ubuntu@ec2-13-215-173-108.ap-southeast-1.compute.amazonaws.com "cd ~/simple-java-maven-app && git pull && whoami && ls -lah && ./simple-java-maven-app/jenkins/scripts/deliver.sh"
        '''
